        ...
        <div className="my-18 text-sm text-slate-600">
            ...
            {product.store && (
                <div className="flex gap-3 mt-14">
                    <Image src={product.store.logo || "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=600&auto=format&fit=crop&q=80"} alt="" className="size-11 rounded-full ring ring-slate-400" width={100} height={100} />
                    <div>
